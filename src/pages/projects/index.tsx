...
const ProjectsPage = () => {
  const [featuredProjects] = useState(
    PastProjects.filter((project: Project) => project.featured === true),
  );
  const [bestOverallProjects] = useState(
    PastProjects.filter((project: Project) => project.showcaseWinner === true),
  );
  return (
    <div
      className="relative box-border size-full overflow-hidden scroll-smooth whitespace-normal border-none bg-[var(--dark-background)] p-0 font-['Inter',Tahoma,sans-serif] leading-normal"
      id="projectsPageTop"
    >
      <div className="mb-[15%] bg-white py-20 text-[var(--secondary-grey)] md:mb-[25%] md:flex">
...
>>>>>>> 4d7fcfa (Starting to Migrate Projects Page. Some Styling is off.)
      ...
      <div className="flex flex-col justify-center">
        {bestOverallProjects.map((project: Project, index: number) => (
          <div data-aos="fade-up" data-aos-duration="800" key={index}>
            <h2
            ...
            <div className="m-[5%] grid max-w-[1400px] md:grid-cols-2">
              <span className="text-center md:text-left">
                <h1 className="BabyHeading BabyHeading--white">
                  Congratulations {project.name}!
                </h1>
                <p className="regularText regularText--white">
                  {project.description}
                </p>
                <div className="justify-left mb-[1%] flex md:justify-center">
                  <HoverButton
      ...
      <div data-aos="fade-up" data-aos-duration="800">
        ...
        >
          ...
          in action. <br></br> Have an idea for a cool project you&apos;d like
          to bring to life with Tech Start?
        </h3>
        <div className="mb-[1%] flex justify-center">
          <HoverButton
            glowOnHover={true}
